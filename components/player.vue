<template>
<div class="dark">
<div class="bg-slate-800 border-slate-500 border-b rounded-t-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8">
    <div class="flex items-center space-x-4">
      <img src="https://play-lh.googleusercontent.com/PdndnWPEaztvwVnYJh7GbSwDJ9xDJOwLonmx6klDL3uy0NE-X_YQttQ_z0166Wi1zsY=w240-h480-rw" alt="" width="88" height="88" loading="lazy" />
      <div class="min-w-0 flex-auto space-y-1 font-semibold">
        <p class="text-cyan-400 text-sm leading-6">
    ...
    <div class="space-y-2">
      <div class="relative">
        <div class="bg-slate-700 rounded-full overflow-hidden">
          <div ref="progress" class="bg-cyan-400 w-1/2 h-2" role="progressbar" aria-label="music progress" aria-valuenow="1456" aria-valuemin="0" aria-valuemax="4550"></div>
        </div>
        <div ref="circle" class="ring-cyan-400 ring-2 absolute left-1/2 top-1/2 w-4 h-4 -mt-2 -ml-2 flex items-center justify-center bg-white rounded-full shadow">
          <div class="w-1.5 h-1. bg-cyan-400 rounded-full ring-1 ring-inset ring-slate-900/5"></div>
        </div>
      </div>
      <div class="flex justify-between text-sm leading-6 font-medium tabular-num">
  ...
  <div class=" bg-slate-600 text-slate-200 rounded-b-xl flex items-center">
    ...
    <button type="button" class=" bg-slate-100 text-slate-700 flex-none -my-2 mx-auto w-20 h-20 rounded-full ring-1 ring-slate-900/5 shadow-md flex items-center justify-center" aria-label="Pause">
    ...
    <div class="flex-auto flex items-center justify-evenly">
      ...
      <button type="button" class="rounded-lg text-xs leading-6 font-semibold px-2 ring-inset ring-slate-500  text-slate-100 ring-0 bg-slate-500">
        1x
      </button>
    </div>
  </div>
